defmodule TidetrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TidetrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TidetrackerWeb.Gettext, "errors", msg, opts)
    end
  end
